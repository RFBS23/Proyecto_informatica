...
namespace presentacion
{
    public partial class frmVentas : Form
    {
        ...
        {
            using (var modal = new modProductos())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    txtcodigo.Text = modal._Productos.codigo.ToString();
                    txtnombres.Text = modal._Productos.nombre.ToString() + " " + modal._Productos.descripcion.ToString() + " " + modal._Productos.modelo.ToString() + " " + modal._Productos.marca.ToString();
                    /*
                     * cbcategoria.Text = modal._Productos.oCategoria.nombrecategoria;
                     * cbsubcategoria.Text = modal._Productos.oSubcategoria.nombresubcategoria;
                     * txtmodelo.Text = modal._Productos.modelo.ToString();
                     * txtmarca.Text = modal._Productos.marca.ToString();
                    */
                    txtprecio.Text = modal._Productos.precioventa.ToString("0.00");
