...
namespace presentacion
{
    public partial class frmCategorias : Form
    {
        ...
        private void frmCategorias_Load(object sender, EventArgs e)
        {
            ...
            List<Categoria> listaUsuario = new NCategorias().Listar();
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                int idusuariogenerado = new NCategorias().Registrar(objcategorias, out mensaje);
            ...
            {
                bool resultado = new NCategorias().Editar(objcategorias, out mensaje);
                if (resultado)
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtid.Text) != 0)
            {
                if (MessageBox.Show("¿ESTA SEGURO DE ELIMINAR A ESTA CATEGORIA?", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new NCategorias().Eliminar(objcategoria, out mensaje);
                    if (respuesta)
                    {
